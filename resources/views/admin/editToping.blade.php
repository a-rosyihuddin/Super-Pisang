...
@section('container')
  <div class="main-card mb-3 card">
    <div class="card-body">
      <form method="POST" action="{{ Route('admin.actionEditToping', $toping->id) }}">
        @csrf
        <div class="position-relative row form-group">
          ...
          <div class="col-sm-10">
            <input name="nama_toping" id="namaToping" placeholder="Masukkan Nama Toping" type="text"
              class="form-control @error('nama_toping') is-invalid @enderror" value="{{ $toping->nama_toping }}">
            @error('nama_toping')
        ...
        <div class="position-relative row form-group">
          ...
          <div class="col-sm-10">
            <input name="harga" id="hargaToping" placeholder="Masukkan Harga Menu" type="number"
              class="form-control @error('harga') is-invalid @enderror" value="{{ $toping->harga }}">
            @error('harga_toping')
              <div class="invalid-feedback">{{ $message }}</div>
            @enderror
          </div>
